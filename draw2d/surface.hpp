...
{	
	...
	public:
		Surface( Index aWidth, Index aHeight );	// Constructure 
		~Surface();		// Destructor 
	...
	private:
		// Member Variables 
		std::uint8_t* mSurface; // Surface's image data, sRGB, stored as RGBx8
		Index mWidth, mHeight; // The width and height of the Surface in pixels
